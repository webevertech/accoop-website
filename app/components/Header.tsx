      ...
      <nav className="max-w-9xl mx-auto px-4 sm:px-6 lg:px-8" aria-label="Main navigation">
        <div className="flex justify-between items-center h-24">
          ...
          <div className="hidden lg:flex items-center space-x-3">
            <LoginButton className="border-2 border-primary text-primary hover:bg-primary hover:text-white px-5 py-2 rounded-full font-medium transition-all duration-300 inline-flex items-center justify-center">
              Sign In
            </LoginButton>
        ...
        {isMenuOpen && (
          <div className="lg:hidden pb-4 animate-fadeIn">
            <div className="flex flex-col space-y-2">
              ...
              <LoginButton
                className="mx-4 mt-2 border-2 border-primary text-primary px-6 py-2.5 rounded-full font-medium text-center transition-colors inline-flex items-center justify-center"
              >
                Sign In
              </LoginButton>
              <CTAButton
